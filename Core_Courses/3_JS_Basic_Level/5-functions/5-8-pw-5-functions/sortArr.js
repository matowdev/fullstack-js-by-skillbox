...
// функция сортировки массива методом "пузырька", посредствам двух циклов for
...
// функция сортировки массива "пузырьком", посредствам одного цикла do..while
// данные подход считается более эффективным чем два вложенных цикла for, которые всегда выполняются полностью
...
// функция сортировки массива "внутренним" методом sort()
