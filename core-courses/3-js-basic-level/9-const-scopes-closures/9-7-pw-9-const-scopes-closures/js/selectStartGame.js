(() => {
  document.addEventListener('DOMContentLoaded', () => {
    ...
    const initialPageState = {
      ...
      audioWrapClassList: document.querySelector('.footer__audio-wrap')
        .className,
    };
    ...
    const playfieldAreaWrap = document.querySelector(
    ...
    function returnToInitialState() {
      ...
      document.querySelector('.page').className =
        initialPageState.pageClassList;
